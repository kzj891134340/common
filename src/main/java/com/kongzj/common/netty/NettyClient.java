package com.kongzj.common.netty;
...
/**
 * @author kongzj Create At 2018/10/15 11:03
 */
@Slf4j
...
public class NettyClient extends ChannelInboundHandlerAdapter {
    ...
    public void channelReadComplete(ChannelHandlerContext ctx) throws Exception {
        log.info("read complete. close channel.");
        ctx.close();
    }

    @Override
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        log.error("NettyClient Exception, close channel.", cause);
